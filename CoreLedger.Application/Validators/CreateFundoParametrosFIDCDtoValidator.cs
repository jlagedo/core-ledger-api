...
/// <summary>
///     Validator for CreateFundoParametrosFIDCDto.
/// </summary>
public class CreateFundoParametrosFIDCDtoValidator : AbstractValidator<CreateFundoParametrosFIDCDto>
{
    public CreateFundoParametrosFIDCDtoValidator()
    {
        RuleFor(x => x.FundoId)
            .NotEmpty()
